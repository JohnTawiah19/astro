...
function M(e, t) {
  if (e.attributes.length === 0 && t.attributes.length === 0)
    return [];
  let r = [], n = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Map();
  for (let s of e.attributes)
    n.set(s.name, s.value);
  for (let s of t.attributes) {
    let o = n.get(s.name);
    s.value === o ? n.delete(s.name) : (typeof o < "u" && n.delete(s.name), a.set(s.name, s.value));
  }
  for (let s of n.keys())
    r.push({ type: 5, name: s });
  for (let [s, o] of a.entries())
    r.push({ type: 4, name: s, value: o });
  return r;
}
function N(e, t = true) {
  let r = `${e.localName}`;
  for (let { name: n, value: a } of e.attributes)
    t && n.startsWith("data-") || (r += `[${n}=${a}]`);
...
function v(e) {
  let [t, r = ""] = e.split("?"), n = new URLSearchParams(r);
  return n.set("t", `${Date.now()}`), `${t}?${n}`;
}
function u(e) {
  ...
  if (e.nodeType === 1 && e.localName === "script") {
    ...
    for (let { name: r, value: n } of e.attributes)
      r === "src" && (n = v(n)), t.setAttribute(r, n);
...
function x(e, t) {
  if (e.children.length === 0 && t.children.length === 0)
    return [];
  let r = [], n = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map();
  for (let o of e.children)
    n.set(h(o), o);
  for (let o of t.children) {
    let i = h(o), c = n.get(i);
    c ? N(o, false) !== N(c, false) && a.set(i, u(o)) : s.set(i, u(o)), n.delete(i);
  }
  for (let o of e.childNodes) {
    if (o.nodeType === 1) {
      ...
      if (n.has(i)) {
        ...
        let c = a.get(i);
        r.push({ type: 3, attributes: M(o, c), children: I(o, c) });
        continue;
      }
    }
    r.push(void 0);
  ...
  for (let o of s.values())
    r.push({ type: 0, node: u(o) });
  return r;
}
function I(e, t) {
  let r = [], n = Math.max(e.childNodes.length, t.childNodes.length);
  for (let a = 0; a < n; a++) {
    let s = e.childNodes.item(a), o = t.childNodes.item(a);
    r[a] = p(s, o);
  }
  return r;
}
...
function P(e, t) {
  if (t.length !== 0)
    for (let { type: r, name: n, value: a } of t)
      r === 5 ? e.removeAttribute(n) : r === 4 && e.setAttribute(n, a);
}
async function O(e, t, r) {
  ...
  switch (e.nodeType === 9 ? (e = e.documentElement, n = e) : r ? n = r : n = e, t.type) {
    ...
    case 3: {
      if (!n)
        return;
      let { attributes: a, children: s } = t;
      P(n, a);
      let o = Array.from(n.childNodes);
      await Promise.all(s.map((i, c) => O(n, i, o[c])));
      return;
    }
  }
}
...
// dep:micromorph
var micromorph_default = $;
export {
  micromorph_default as default,
  p as diff,
  O as patch
};
//# sourceMappingURL=micromorph.js.map
